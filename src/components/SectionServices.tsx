...
const SectionServices = () => {
  ...
  return (
    <div className="relative bg-[#141416] py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-10 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-[30%] w-72 h-72 bg-[#CAFB42] opacity-5 blur-[120px] rounded-full pointer-events-none"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-16">
        ...
        >
          ...
          <MotionLink
            to="/xidmətlərimiz"
            variants={leftSideVariants}
            className="rounded-full px-10 py-4 font-bold bg-[#CAFB42] text-black hover:bg-white transition-all duration-300 cursor-pointer uppercase text-xs tracking-wider mt-4"
          >
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-6">
          {services.map((service, i) => (
            <motion.div
              ...
              className="flex flex-col sm:flex-row items-center sm:items-start bg-[#1a1a1c] p-6 sm:p-8 rounded-2xl gap-6 hover:bg-[#222225] transition-colors duration-300 border border-white/5 group"
            >
              <div className="shrink-0 w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden border-2 border-transparent group-hover:border-[#CAFB42] transition-all duration-500">
                <img
                  src={service.img}
                  alt={service.title}
